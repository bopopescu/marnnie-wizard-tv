...
base='www.andrewrx.com'
ADDON=xbmcaddon.Addon(id='plugin.video.Kodiwizardmj')
...
def CATEGORIES():
    link = OPEN_URL('https://copy.com/BY7EDt7W4OSm8tiA').replace('\n','').replace('\r','')
...
def wizard(name,url,description):
    ...
    dp.create("Marnnie Wizard","Downloading ",'', 'Please Wait')
