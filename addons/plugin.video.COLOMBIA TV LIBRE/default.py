...
Base = 'https://raw.githubusercontent.com/adrianhn/adryanlist/master/list.xml' #    modificar("la ruta de tus listas")

addon = xbmcaddon.Addon('plugin.video.COLOMBIA TV LIBRE') #    modificar("el nombre de tu addons")
