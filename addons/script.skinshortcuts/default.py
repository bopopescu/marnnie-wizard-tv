...
__mainpath__   = os.path.join( xbmc.translatePath( "special://mainprofile/" ).decode( 'utf-8' ), "addon_data", __addonid__ )
...
class Main:
    ...
    def __init__(self):
        ...
        if not xbmcvfs.exists(__mainpath__):
            xbmcvfs.mkdir(__mainpath__)
